...
var _LolSearch = __webpack_require__(29);

var _LolSearch2 = _interopRequireDefault(_LolSearch);

var _LolChracter = __webpack_require__(30);

var _LolChracter2 = _interopRequireDefault(_LolChracter);

var _LolReport = __webpack_require__(32);

var _LolReport2 = _interopRequireDefault(_LolReport);

var _lolChampions = __webpack_require__(33);
	...
	_createClass(App, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_LolSearch2.default, null),
				_react2.default.createElement('hr', null),
				_react2.default.createElement(_LolChracter2.default, { image: this.state.image, name: this.state.name, chracterstate: this.state.chracterstate, clickCharacter: this.clickCharacter }),
				_react2.default.createElement('hr', null),
				_react2.default.createElement(_LolReport2.default, null)
			);
		}
	}]);
...
var LolSearch = function (_React$Component) {
	...
	function LolSearch() {
		...
		return _possibleConstructorReturn(this, (LolSearch.__proto__ || Object.getPrototypeOf(LolSearch)).apply(this, arguments));
	}
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"div",
							{ "class": "input-group" },
							_react2.default.createElement("input", { "class": "form-control", type: "text" }),
							_react2.default.createElement(
								"span",
...
var _ChracterCard = __webpack_require__(31);
...
var LolChracter = function (_React$Component) {
	...
	function LolChracter(props) {
		...
		var _this = _possibleConstructorReturn(this, (LolChracter.__proto__ || Object.getPrototypeOf(LolChracter)).call(this, props));
		...
		value: function render() {
			...
			var mapToCharacterCard = function mapToCharacterCard(data) {
				return data.map(function (data, i) {
					return _react2.default.createElement(_ChracterCard2.default, { data: data, key: i, clickCharacter: _this2.props.clickCharacter });
				});
			};

			console.log("test.  " + _typeof(this.props.clickCharacter));
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(
					'div',
					{ 'class': 'btn-group', onClick: function onClick(e) {
...
var ChracterCard = function (_React$Component) {
	...
	function ChracterCard(props) {
		...
		var _this = _possibleConstructorReturn(this, (ChracterCard.__proto__ || Object.getPrototypeOf(ChracterCard)).call(this, props));
	...
	_createClass(ChracterCard, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement("img", { src: "", alt: this.props.data.id }),
				_react2.default.createElement(
					"div",
					{ "class": "card-img-overlay", onClick: function onClick(e) {
							console.log("A");
							{/*this.clickTest(e);*/}z;
							_this2.props.clickCharacter(e);
						} },
...
var LolReport = function (_React$Component) {
	_inherits(LolReport, _React$Component);

	function LolReport() {
		_classCallCheck(this, LolReport);

		return _possibleConstructorReturn(this, (LolReport.__proto__ || Object.getPrototypeOf(LolReport)).apply(this, arguments));
	}

	_createClass(LolReport, [{
		key: "render",
		value: function render() {
			return _react2.default.createElement(
				"div",
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ "class": "col-sm-3 bg-secondary" },
						"image"
					),
					_react2.default.createElement(
						"div",
						{ "class": "col-sm-9 bg-primary" },
						"status"
					)
				)
			);
